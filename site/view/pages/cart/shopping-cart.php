    ...
    <div class="shop-section mb-80">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <?php
include "./view/pages/cart/nav-tab.php";
?>
                </div>
                <div class="col-lg-10">
                    <!-- Tab panes -->
...
?>
                                    ...
                                    <a href="#checkout" data-bs-toggle="tab" arial-selected="false" tabindex="-1"
                                        role="tab" class="btn btn-dark mb-5 ml-auto d-block">Thanh
                                        toán</a>
