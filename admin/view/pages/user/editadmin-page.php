...
?>
    <div class="card">
        <<<<<<< HEAD <a class="my-3 d-inline-block btn btn-outline-primary col-xl-3 ms-3"
            href="./index.php?act=adminlist">
                    ...
                    <form class="row g-3" action="<?php echo "index.php?act=editadmin&id=" . $_GET['id'] ?>"
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="address" value="<?php echo $user['diachi'] ?>"
                                required>
                            <p class="error-message"><?php echo isset($error['address']) ? $error['address'] : ''; ?>
                            </p>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="username"
                                value="<?php echo $user['tai_khoan'] ?>" required>
                            <p class="error-message"><?php echo isset($error['username']) ? $error['username'] : ''; ?>
                            </p>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <select name="role" class="form-select" aria-label="Default select example">
                                ...
                                <option <?php if ($user['vai_tro'] == 1) {echo 'selected';}?> value="1">Quản Trị Viên
                                </option>
