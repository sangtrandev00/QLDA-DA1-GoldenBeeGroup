...
?>
    ...
    <a class="my-3 d-inline-block btn btn-outline-primary col-xl-3 ms-3" href="./index.php?act=adminlist">
              ...
              <div class="card-body">
                ...
                <hr/>
                <form class="row g-3" id="form-edit-admin"  action="<?php echo "index.php?act=editadmin&id=" . $_GET['id'] ?>"
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="address" value="<?php echo $user['diachi'] ?>" required>
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" name="phone" value="<?php echo $user['sodienthoai'] ?>" required>
                    <p class="error-message"><?php echo isset($error['phone']) ? $error['phone'] : ''; ?></p>
                  </div>
                  <div class="col-12">
                    <label class="form-label">Kích hoạt:</label>
                    <input type="number" class="form-control" min=0 max=1 name="kichhoat" value="<?php echo $user['kich_hoat'] ?>" required>
                  </div>
                  <div class="col-12">
                    <label class="form-label">Username</label>
                    <input type="text" class="form-control" name="username" value="<?php echo $user['tai_khoan'] ?>" required>
                    <p class="error-message"><?php echo isset($error['username']) ? $error['username'] : ''; ?></p>
                  </div>
                  <div class="col-12">
                    <label class="form-label">Password:</label>
                    <input type="text" class="form-control" name="password" value="<?php echo $user['mat_khau'] ?>" required>
                    <p class="error-message"><?php echo isset($error['password']) ? $error['password'] : ''; ?></p>
                  </div>
                  <div class="col-12">
                    <label class="form-label">Hình ảnh:</label>
                    <?=$hinh?>
                    <input type="file" class="form-control" name="image" style="margin-top: 5px;" value="" accept="image/gif, image/jpeg, image/png, image/jpg">
                  ...
                  <div class="col-12">
                    <label class="form-label">Chọn vai trò:</label>
                        <select name="role" class="form-select" aria-label="Default select example">
                            ...
                            <option <?php if ($user['vai_tro'] == 1) {echo 'selected';}?>
                                value="1">Quản Trị Viên</option>
                            <option <?php if ($user['vai_tro'] == 2) {echo 'selected';}?>
                                value="2">Nhân Viên</option>
                            <option <?php if ($user['vai_tro'] == 3) {echo 'selected';}?>
                  ...
                  <div class="col-12">
                    ...
                    <input type="submit" name="edituserbtn" value="Cập nhật quản trị viên" class="btn btn-primary" />
                    </div>
                  </div>
                </form>
              </div>
