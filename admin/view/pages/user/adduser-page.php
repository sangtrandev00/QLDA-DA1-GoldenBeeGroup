                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="border p-3 rounded">
                                                    ...
                                                    <hr />
                                                    <form class="row g-3" action="./index.php?act=adduser" method="post"
                                                        enctype="multipart/form-data">
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="number" class="form-control" min=0 max=1
                                                                name="kichhoat" value="1" required>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <<<<<<< HEAD <div class="col-12">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="file" class="form-control" name="image"
                                                                    value=""
                                                                    accept="image/gif, image/jpeg, image/png, image/jpg">
                                                                >>>>>>> f170d61 (Check form edit user/admin list and
                                                                add)
                                                                <p class="error-message">
                                                                    <?php echo isset($error['img']) ? $error['img'] : ''; ?>
                                                                </p>
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                <div class="d-grid">
                                                                    ...
                                                                    <input type="submit" name="adduserbtn"
