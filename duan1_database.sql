...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 01, 2023 lúc 02:36 PM
...
(3, 'SALEOF_10', 10.00, 4000000.00, 11, '2023-03-30 11:15:03', '2023-04-30 16:15:04'),
(4, 'SALEOFF_15', 15.00, 5000000.00, 99, '2023-03-30 11:44:06', '2023-04-04 16:44:06'),
(5, 'SALEOFF_20', 20.00, 8000000.00, 9, '2023-03-31 04:36:43', '2023-04-19 09:36:43'),
...
(11, 'trannhatsang', '827ccb0eea8a706c4c34a16891f84e7b', 'Trần Nhật Sang', '123', 1, '0937988510', 1, '../uploads/Anh Bong Da SVD.jpg', 'nhatsang0101@gmail.com', 1, 'fpt polytechnic1', 'vnpaypayment', NULL),
(18, 'admin', '827ccb0eea8a706c4c34a16891f84e7b', 'Tran Nhat Sang', '19/7c', 2, '0937988510', 1, 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80', 'nhatsang0101@gmail.com', 1, NULL, 'codpayment', NULL),
...
(8, 'Điện thoại OPPO A76', 5390000.00, 99, 'thumb-combo_a76_-_black.jpg,oppo-a76-3.jpg,a76 combo blue chuan.jpg,combo_a76_blue_dep.jpg,combo_a76_-_blue.jpg,', 10.00, 0, 3, '2023-03-12 09:21:43', '2023-03-14 15:25:01', 'OPPO A76 4G ra mắt với thiết kế trẻ trung, hiệu năng ổn định, màn hình 90 Hz mượt mà cùng viên pin trâu cho thời gian sử dụng lâu dài phù hợp cho mọi đối tượng người dùng.\nThiết kế OPPO Glow - màu gradient đẹp mắt\nThoải mái dùng cả ngày với pin 5000 mAh và sạc nhanh 33 W\nHiệu năng ổn định với chip Snapdragon 680', 1, 1, 'Màn hình:\r\n\r\nIPS LCD6.56\"HD+\r\nHệ điều hành:\r\n\r\nAndroid 11\r\nCamera sau:\r\n\r\nChính 13 MP & Phụ 2 MP\r\nCamera trước:\r\n\r\n8 MP\r\nChip:\r\n\r\nSnapdragon 680\r\nRAM:\r\n\r\n6 GB\r\nDung lượng lưu trữ:\r\n\r\n128 GB\r\nSIM:\r\n\r\n2 Nano SIMHỗ trợ 4G\r\nPin, Sạc:\r\n\r\n5000 mAh33 W', 0, 0.0),
...
--
ALTER TABLE `tbl_coupon`
  MODIFY `id_coupon` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `tbl_danhgiasp`
--
ALTER TABLE `tbl_danhgiasp`
  MODIFY `id_review` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tbl_vnpay`
  MODIFY `id_vnpay` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
